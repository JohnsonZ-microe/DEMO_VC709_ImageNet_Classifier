...
pickle.dump( M1_save, open( "D:\\Postgraduate\\project\\MobileNet\\MobileNetV2_numpy\\coe\\layer1\\M1.p", "wb" ) )
pickle.dump( input_quantized, open( "D:\\Postgraduate\\project\\MobileNet\\MobileNetV2_numpy\\coe\\layer1\\ifmap.p", "wb" ) )
pickle.dump( weight_quantized, open( "D:\\Postgraduate\\project\\MobileNet\\MobileNetV2_numpy\\coe\\layer1\\weight.p", "wb" ) )
...
output_scale = output_scale_list[27]# change
...
for i in range(1000):
    ...
    output_1000[i] = np.round(weight_scale*input_scale/output_scale*w_mul_x + output_zero + bias[i]/output_scale)
'''       
#%%
