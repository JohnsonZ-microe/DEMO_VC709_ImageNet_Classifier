    ...
    try:
        ...
        for idx in diff_indices:
            ...
            diff_info = {
                ...
                "numpy Value": hard[tuple(coords)],
                "pytorch Value": soft[tuple(coords)],
...
def generate_comparison_groups(start_layer, end_layer, shortcut_layers=None):
    ...
    for layer in range(start_layer, end_layer + 1):
        ...
        groups.append({
            "name": f"Layer{layer}",
            "hardware": f"accelerate_output_layer{layer}.npy",
            "software": f"unaccelerated_output_layer{layer}.npy"
        })
        ...
        if layer in shortcut_layers:
            groups.append({
                ...
                "hardware": f"accelerate_output_layer{layer}_shortcut.npy",
                "software": f"unaccelerated_output_layer{layer}_shortcut.npy"
            })
