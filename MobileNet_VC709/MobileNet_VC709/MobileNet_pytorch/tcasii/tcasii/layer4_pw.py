...
M1_list_layer4 = M1_list_bias_fuse[3]
w_layer4_pw    = weight_quantized_list[3]
...
for i in range(9):
    with open("D:\\Spyder Project\\mobilenetv2_demo\\layer1_to_53_M_V1_bias32b\\tcasii\\layer4\\weight_layer4_"+str(i)+".txt","w+") as f:
...
with open("D:\\Spyder Project\\mobilenetv2_demo\\layer1_to_53_M_V1_bias32b\\tcasii\\layer4\\m1_layer4.txt","w+") as f:
    f.write("memory_initialization_radix=2;\n") # 数据以2进制格式存储
    f.write("memory_initialization_vector=\n")
...
w_layer4_pw    = weight_quantized_list[3]
np.save("D:\\Spyder Project\\mobilenetv2_demo\\layer1_to_53_M_V1_bias32b\\tcasii\\layer4\\w_layer4_pw.npy",w_layer4_pw)