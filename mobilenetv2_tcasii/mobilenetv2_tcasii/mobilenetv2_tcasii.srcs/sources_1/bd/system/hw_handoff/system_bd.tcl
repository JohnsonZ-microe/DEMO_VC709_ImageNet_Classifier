...
proc create_root_design { parentCell } {
  ...
  set bram_addr_a_0 [ create_bd_port -dir O -from 24 -to 0 bram_addr_a_0 ]
  ...
  connect_bd_intf_net -intf_net axi_clock_converter_0_M_AXI [get_bd_intf_pins axi_bram_ctrl_0/S_AXI] [get_bd_intf_pins axi_clock_converter_0/M_AXI]
  ...
  connect_bd_net -net CLKIN_1 [get_bd_ports CLKIN] [get_bd_pins xdma_0/sys_clk]
  connect_bd_net -net Net [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_clock_converter_0/m_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net Net1 [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_clock_converter_0/m_axi_aresetn] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net axi_bram_ctrl_0_bram_addr_a [get_bd_ports bram_addr_a_0] [get_bd_pins axi_bram_ctrl_0/bram_addr_a]
  connect_bd_net -net axi_bram_ctrl_0_bram_clk_a [get_bd_ports bram_clk_a_0] [get_bd_pins axi_bram_ctrl_0/bram_clk_a]
  connect_bd_net -net axi_bram_ctrl_0_bram_en_a [get_bd_ports bram_en_a_0] [get_bd_pins axi_bram_ctrl_0/bram_en_a]
  connect_bd_net -net axi_bram_ctrl_0_bram_rst_a [get_bd_ports bram_rst_a_0] [get_bd_pins axi_bram_ctrl_0/bram_rst_a]
  connect_bd_net -net axi_bram_ctrl_0_bram_we_a [get_bd_ports bram_we_a_0] [get_bd_pins axi_bram_ctrl_0/bram_we_a]
  connect_bd_net -net axi_bram_ctrl_0_bram_wrdata_a [get_bd_ports bram_wrdata_a_0] [get_bd_pins axi_bram_ctrl_0/bram_wrdata_a]
  connect_bd_net -net bram_rddata_a_0_1 [get_bd_ports bram_rddata_a_0] [get_bd_pins axi_bram_ctrl_0/bram_rddata_a]
  ...
  create_bd_addr_seg -range 0x02000000 -offset 0x00000000 [get_bd_addr_spaces xdma_0/M_AXI] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
