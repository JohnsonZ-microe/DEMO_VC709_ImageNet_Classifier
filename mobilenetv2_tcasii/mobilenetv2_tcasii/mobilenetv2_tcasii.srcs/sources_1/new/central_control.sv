...
module central_control(
  ...
  begin
    ...
    unique case(current_state)
             ...
             DONE:
             begin
              if(!control_source) next_state = IDLE;
  ...
  begin
    if(!rst_n)
      cnt_layer <= 7'd0;
    else if((cnt_layer == 7'd64) && complete) cnt_layer <= 0;
    else if(current_state == DONE) cnt_layer <= 0;
  ...
  begin
    ...
    // config_data[0][7] =  32'b0000000011_00000000011_0000111_0_101; 
    ...
    config_data[0][1] =  32'd0;     // ifmp BRAM base addr
    config_data[0][2] =  32'd5776;  // ofmp BRAM base addr
    config_data[0][3] =  32'd0;     // weight BRAM base addr
    config_data[0][4] =  32'd0;     // M1 BRAM base addr
    config_data[0][5] =  32'd0;    // SC base addr
    ...
    config_data[1][1] =  32'd5776;     // ifmp BRAM base addr
    config_data[1][2] =  32'd0;  // ofmp BRAM base addr
    ...
    config_data[2][1] =  32'd0;     // ifmp BRAM base addr
    config_data[2][2] =  32'd15884;  // ofmp BRAM base addr
    ...
    config_data[3][1] =  32'd15884;     // ifmp BRAM base addr
    config_data[3][2] =  32'd0;  // ofmp BRAM base addr
    ...
    config_data[4][1] =  32'd0;     // ifmp BRAM base addr
    config_data[4][2] =  32'd15884;  // ofmp BRAM base addr
    ...
    config_data[5][1] =  32'd15884;     // ifmp BRAM base addr
    config_data[5][2] =  32'd0;  // ofmp BRAM base addr
    ...
    config_data[6][1] =  32'd0;     // ifmp BRAM base addr
    config_data[6][2] =  32'd6000;  // ofmp BRAM base addr
    ...
    config_data[7][1] =  32'd6000;     // ifmp BRAM base addr
    config_data[7][2] =  32'd11776;  // ofmp BRAM base addr
    ...
    config_data[8][1] =  32'd11776;     // ifmp BRAM base addr
    config_data[8][2] =  32'd2000;  // ofmp BRAM base addr
    ...
    config_data[9][1] =  32'd2000;     // fx BRAM base addr
    config_data[9][2] =  32'd4000;  // ofmp BRAM base addr
    config_data[9][3] =  32'd50126;     // M1
    config_data[9][4] =  32'd0;
    config_data[9][5] =  32'd0;    // SC x base addr
    ...
    config_data [10][1] = 32'd4000; //ifmp BRAM base addr（上一层 layer9_shortcut 的 start_addr）
    config_data [10][2] = 32'd6000; //ofmp BRAM base addr（当前层 layer10 的 start_addr）
    ...
    config_data [11][1] = 32'd6000; //ifmp BRAM base addr（上一层 layer10 的 start_addr）
    config_data [11][2] = 32'd11776; //ofmp BRAM base addr（当前层 layer11 的 start_addr）
    ...
    config_data [12][1] = 32'd11776; //ifmp BRAM base addr（上一层 layer11 的 start_addr）
    config_data [12][2] = 32'd0; //ofmp BRAM base addr（当前层 layer12 的 start_addr）
    ...
    config_data [13][1] = 32'd0; //ifmp BRAM base addr（上一层 layer12 的 start_addr）
    config_data [13][2] = 32'd6000; //ofmp BRAM base addr（当前层 layer13 的 start_addr）
    ...
    config_data [14][1] = 32'd6000; //ifmp BRAM base addr（上一层 layer13 的 start_addr）
    config_data [14][2] = 32'd8200; //ofmp BRAM base addr（当前层 layer14 的 start_addr）
    ...
    config_data [15][1] = 32'd8200; //ifmp BRAM base addr（上一层 layer14 的 start_addr）
    config_data [15][2] = 32'd2000; //ofmp BRAM base addr（当前层 layer15 的 start_addr）
    ...
    config_data [16][1] = 32'd2000; //ifmp BRAM base addr（上一层 layer15 的 start_addr）
    config_data [16][2] = 32'd4000; //ofmp BRAM base addr（当前层 layer15_shortcut 的 start_addr）
    ...
    config_data [16][5] = 32'd0; // SC base addr（前面第三层 13 的 start_addr）
    ...
    config_data [17][1] = 32'd4000; //ifmp BRAM base addr（上一层 layer15_shortcut 的 start_addr）
    config_data [17][2] = 32'd6000; //ofmp BRAM base addr（当前层 layer16 的 start_addr）
    ...
    config_data [18][1] = 32'd6000; //ifmp BRAM base addr（上一层 layer16 的 start_addr）
    config_data [18][2] = 32'd8200; //ofmp BRAM base addr（当前层 layer17 的 start_addr）
    ...
    config_data [19][1] = 32'd8200; //ifmp BRAM base addr（上一层 layer17 的 start_addr）
    config_data [19][2] = 32'd2000; //ofmp BRAM base addr（当前层 layer18 的 start_addr）
    ...
    config_data [20][1] = 32'd2000; //ifmp BRAM base addr（上一层 layer18 的 start_addr）
    config_data [20][2] = 32'd0; //ofmp BRAM base addr（当前层 layer18_shortcut 的 start_addr）
    ...
    config_data [20][5] = 32'd4000; // SC base addr
    ...
    config_data [21][1] = 32'd0; //ifmp BRAM base addr（上一层 layer18_shortcut 的 start_addr）
    config_data [21][2] = 32'd6000; //ofmp BRAM base addr（当前层 layer19 的 start_addr）
    ...
    config_data [22][1] = 32'd6000; //ifmp BRAM base addr（上一层 layer19 的 start_addr）
    config_data [22][2] = 32'd8200; //ofmp BRAM base addr（当前层 layer20 的 start_addr）
    ...
    config_data [23][1] = 32'd8200; //ifmp BRAM base addr（上一层 layer20 的 start_addr）
    config_data [23][2] = 32'd0; //ofmp BRAM base addr（当前层 layer21 的 start_addr）
    ...
    config_data [24][1] = 32'd0; //ifmp BRAM base addr（上一层 layer21 的 start_addr）
    config_data [24][2] = 32'd6000; //ofmp BRAM base addr（当前层 layer22 的 start_addr）
    ...
    config_data [25][1] = 32'd6000; //ifmp BRAM base addr（上一层 layer22 的 start_addr）
    config_data [25][2] = 32'd7075; //ofmp BRAM base addr（当前层 layer23 的 start_addr）
    ...
    config_data [26][1] = 32'd7075; //ifmp BRAM base addr（上一层 layer23 的 start_addr）
    config_data [26][2] = 32'd2000; //ofmp BRAM base addr（当前层 layer24 的 start_addr）
    ...
    config_data [27][1] = 32'd2000; //ifmp BRAM base addr（上一层 layer24 的 start_addr）
    config_data [27][2] = 32'd4000; //ofmp BRAM base addr（当前层 layer24_shortcut 的 start_addr）
    ...
    config_data [27][5] = 32'd0; // SC base addr
    ...
    config_data [28][1] = 32'd4000; //ifmp BRAM base addr（上一层 layer24_shortcut 的 start_addr）
    config_data [28][2] = 32'd6000; //ofmp BRAM base addr（当前层 layer25 的 start_addr）
    ...
    config_data [29][1] = 32'd6000; //ifmp BRAM base addr（上一层 layer25 的 start_addr）
    config_data [29][2] = 32'd7075; //ofmp BRAM base addr（当前层 layer26 的 start_addr）
    ...
    config_data [30][1] = 32'd7075; //ifmp BRAM base addr（上一层 layer26 的 start_addr）
    config_data [30][2] = 32'd2000; //ofmp BRAM base addr（当前层 layer27 的 start_addr）
    ...
    config_data [31][1] = 32'd2000; //ifmp BRAM base addr（上一层 layer27 的 start_addr）
    config_data [31][2] = 32'd0; //ofmp BRAM base addr（当前层 layer27_shortcut 的 start_addr）
    ...
    config_data [31][5] = 32'd4000; // SC base addr
	...
	config_data[32][1] = 32'd0; // ifmp BRAM base addr
	config_data[32][2] = 32'd6000; // ofmp BRAM base addr
	...
	config_data[33][1] = 32'd6000; // ifmp BRAM base addr
	config_data[33][2] = 32'd7075; // ofmp BRAM base addr
	...
	config_data[34][1] = 32'd7075; // ifmp BRAM base addr
	config_data[34][2] = 32'd2000; // ofmp BRAM
	...
	config_data[35][1] = 32'd2000; // ifmp BRAM base addr
	config_data[35][2] = 32'd4000; // ofmp BRAM base addr
	config_data[35][3] = 32'd53492; // M1 
	config_data[35][4] = 32'd0; // 
	config_data[35][5] = 32'd0; // SC base addr
	...
	config_data[36][1] = 32'd4000; // ifmp BRAM base addr
	config_data[36][2] = 32'd6000; // ofmp BRAM base addr
	...
	config_data[37][1] = 32'd6000; // ifmp BRAM base addr
	config_data[37][2] = 32'd7075; // ofmp BRAM base addr
	...
	config_data[38][1] = 32'd7075; // ifmp BRAM base addr
	config_data[38][2] = 32'd0; // ofmp BRAM base addr
	...
	config_data[39][1] = 32'd0; // ifmp BRAM base addr
	config_data[39][2] = 32'd6000; // ofmp BRAM base addr
	...
	config_data[40][1] = 32'd6000; // ifmp BRAM base addr
	config_data[40][2] = 32'd7600; // ofmp BRAM base addr
	...
	config_data[41][1] = 32'd7600; // ifmp BRAM base addr
	config_data[41][2] = 32'd2000; // ofmp BRAM base addr
	...
	config_data[42][1] = 32'd2000; // ifmp BRAM base addr
	config_data[42][2] = 32'd4000; // ofmp BRAM base addr
	config_data[42][3] = 32'd42082; // M1 
	config_data[42][4] = 32'd0; // 
	config_data[42][5] = 32'd0; // SC base addr
	...
	config_data[43][1] = 32'd4000; // ifmp BRAM base addr
	config_data[43][2] = 32'd6000; // ofmp BRAM base addr
	...
	config_data[44][1] = 32'd6000; // ifmp BRAM base addr
	config_data[44][2] = 32'd7600; // ofmp BRAM base addr
	...
	config_data[45][1] = 32'd7600; // ifmp BRAM base addr
	config_data[45][2] = 32'd2000; // ofmp BRAM base addr
	...
	config_data[46][1] = 32'd2000; // ifmp BRAM base addr
	config_data[46][2] = 32'd0; // ofmp	 BRAM base addr
	config_data[46][3] = 32'd53372; // M1 
	config_data[46][4] = 32'd0; // 
	config_data[46][5] = 32'd4000; // SC base addr
	...
	config_data[47][1] = 32'd0; // ifmp BRAM base addr
	config_data[47][2] = 32'd6000; // ofmp BRAM base addr
	...
	config_data[48][1] = 32'd6000; // ifmp BRAM base addr
	config_data[48][2] = 32'd7600; // ofmp BRAM base addr
	...
	config_data[49][1] = 32'd7600; // ifmp BRAM base addr
	config_data[49][2] = 32'd0; // ofmp BRAM base addr
	...
	config_data[50][1] = 32'd0; // ifmp BRAM base addr
	config_data[50][2] = 32'd6000; // ofmp BRAM base addr
	...
	config_data[51][1] = 32'd6000; // ifmp BRAM base addr
	config_data[51][2] = 32'd6963; // ofmp BRAM base addr
	...
	config_data[52][1] = 32'd6963; // ifmp BRAM base addr
	config_data[52][2] = 32'd2000; // ofmp BRAM base addr
	...
	config_data[53][1] = 32'd2000; // ifmp BRAM base addr
	config_data[53][2] = 32'd4000; // ofmp BRAM base addr
	config_data[53][3] = 32'd35994; // M1 
	config_data[53][4] = 32'd0; // 
	config_data[53][5] = 32'd0; // SC base addr
	...
	config_data[54][1] = 32'd4000; // ifmp BRAM base addr
	config_data[54][2] = 32'd6000; // ofmp BRAM base addr
	...
	config_data[55][1] = 32'd6000; // ifmp BRAM base addr
	config_data[55][2] = 32'd6963; // ofmp BRAM base addr
	...
	config_data[56][1] = 32'd6963; // ifmp BRAM base addr
	config_data[56][2] = 32'd2000; // ofmp BRAM base addr
	...
	config_data[57][1] = 32'd2000; // ifmp BRAM base addr
	config_data[57][2] = 32'd0; // ofmp BRAM base addr
	config_data[57][3] = 32'd45129; // M1 
	config_data[57][4] = 32'd0; // 
	config_data[57][5] = 32'd4000; // SC base addr
	...
	config_data[58][1] = 32'd0; // ifmp BRAM base addr
	config_data[58][2] = 32'd6000; // ofmp BRAM base addr
	...
	config_data[59][1] = 32'd6000; // ifmp BRAM base addr
	config_data[59][2] = 32'd6963; // ofmp BRAM base addr
	...
	config_data[60][1] = 32'd6963; // ifmp BRAM base addr
	config_data[60][2] = 32'd7926; // ofmp BRAM base addr
	...
	config_data[61][1] = 32'd7926; // ifmp BRAM base addr
	config_data[61][2] = 32'd8250; // ofmp BRAM base addr
  ...
  config_data[62][1] = 32'd8250; // ifmp BRAM base addr
  config_data[62][2] = 32'd9537; // ofmp BRAM base addr
  ...
  config_data[63][1] = 32'd9537; // ifmp BRAM base addr
  config_data[63][2] = 32'd9680; // ofmp BRAM base addr
  ...
  //layer 54 input (1000,1,1) output top5 softmax
  config_data[64][0] = 32'd113; // M0
  config_data[64][1] = 32'd9680; // ifmp BRAM base addr
  config_data[64][2] = 32'd9792; // ofmp BRAM base addr
