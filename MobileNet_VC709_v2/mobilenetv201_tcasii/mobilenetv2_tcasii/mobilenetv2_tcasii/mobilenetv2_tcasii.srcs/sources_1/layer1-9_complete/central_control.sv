...
always_comb begin
	...
	config_data[3][1] =  32'd17177;     // ifmp BRAM base addr
 	...
 	config_data[3][7] =  32'b0000000010_00000001011_1110000_0_011; //general config [31:22]: ifmp, [21:11] ofmp_channel, [10:4]: ifmp_size, [3]:has SC, [2]:stride, [1:0]: 00 IDLE 01 CONV 02 DW 03 PW;
	...
	config_data[4][0] =  32'd2470;   // M0
 	...
 	config_data[4][7] =  32'b0000001011_00000001011_1110000_1_010; //general config [31:22]: ifmp, [21:11] ofmp_channel, [10:4]: ifmp_size, [3]:has SC, [2]:stride, [1:0]: 00 IDLE 01 CONV 02 DW 03 PW;
	...
	config_data[5][0] =  32'd280;   // M0
 	...
 	config_data[5][7] =  32'b0000001011_00000000011_0111000_0_011; //general config [31:22]: ifmp, [21:11] ofmp_channel, [10:4]: ifmp_size, [3]:has SC, [2]:stride, [1:0]: 00 IDLE 01 CONV 02 DW 03 PW;
	...
	config_data[6][0] =  32'd804;   // M0
 	...
 	config_data[6][7] =  32'b0000000011_00000010000_0111000_0_011; //general config [31:22]: ifmp, [21:11] ofmp_channel, [10:4]: ifmp_size, [3]:has SC, [2]:stride, [1:0]: 00 IDLE 01 CONV 02 DW 03 PW;
	...
	config_data[7][0] =  32'd1391;   // M0
 	...
 	config_data[7][7] =  32'b0000010000_00000010000_0111000_0_010; //general config [31:22]: ifmp, [21:11] ofmp_channel, [10:4]: ifmp_size, [3]:has SC, [2]:stride, [1:0]: 00 IDLE 01 CONV 02 DW 03 PW;
	...
	config_data[8][7] =  32'b0000010000_00000000011_0111000_0_011; //general config [31:22]: ifmp, [21:11] ofmp_channel, [10:4]: ifmp_size, [3]:has SC, [2]:stride, [1:0]: 00 IDLE 01 CONV 02 DW 03 PW;
end
