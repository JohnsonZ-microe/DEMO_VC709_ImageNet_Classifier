module counter_dw#
  ...
  always @(posedge clk)begin
    if(!rst_n) begin
      ...
      avgpool_chan_start_reg3 <= 0;
      avgpool_chan_start_reg4 <= 0;
      avgpool_chan_start_reg5 <= 0;
      avgpool_chan_start_reg6 <= 0;
      avgpool_chan_start_reg7 <= 0;
      ...
      avgpool_chan_start_reg3 <= avgpool_chan_start_reg2;
      avgpool_chan_start_reg4 <= avgpool_chan_start_reg3;
      avgpool_chan_start_reg5 <= avgpool_chan_start_reg4;
      avgpool_chan_start_reg6 <= avgpool_chan_start_reg5;
      avgpool_chan_start_reg7 <= avgpool_chan_start_reg6;
