...
assign acc_mode = (mode_reg[7]==2'd3);
wire merge_vld;
...
// assign write_valid =  (mode_reg[5] == 3'd5)? avgpool_out_vld : ((mode_reg[5] == 3'd4) ? sc_valid : write_valid_nosc);
always @( *) begin
    case(mode_reg[5])
        3'd4: begin
            write_valid = sc_valid;
        end
        3'd5: begin
            write_valid = avgpool_out_vld;
        end
        default: begin
            write_valid = write_valid_nosc;
        end
...
assign ofmap_write_0 = (mode_reg[5] == 3'd5)? avgpool_output : ((mode_reg[5] == 3'd4) ? shortcut_output_1 : ofmp);
assign ofmap_write_1 = (mode_reg[5] == 3'd4) ? shortcut_output_2 : ofmp;
assign ofmap_write_2 = (mode_reg[5] == 3'd4) ? shortcut_output_3 : ofmp;
assign ofmap_write_3 = (mode_reg[5] == 3'd4) ? shortcut_output_4 : ofmp;
assign ofmap_write_4 = (mode_reg[5] == 3'd4) ? shortcut_output_5 : ofmp;
assign ofmap_write_5 = (mode_reg[5] == 3'd4) ? shortcut_output_6 : ofmp;
assign ofmap_write_6 = (mode_reg[5] == 3'd4) ? shortcut_output_7 : ofmp;
assign ofmap_write_7 = (mode_reg[5] == 3'd4) ? shortcut_output_8 : ofmp;
assign ofmap_write_8 = (mode_reg[5] == 3'd4) ? shortcut_output_9 : ofmp;
endmodule
